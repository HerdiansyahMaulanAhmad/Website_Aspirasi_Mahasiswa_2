...
<body>
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="alert alert-info" role="alert">
                            Untuk menambahkan aspirasi, silakan <a href="{{ route('login') }}" class="alert-link">login</a> atau <a href="{{ route('register') }}" class="alert-link">daftar</a> terlebih dahulu.
                        </div>
                        @endauth
    ...
    <footer class="mt-5">
        <div class="container">
            <div class="row">
                <div class="col-md-5">
                    <h5 class="mb-3"><i class="fas fa-comment-dots me-2"></i>SAMA-TI adalah suatu website yang menggunakan tenologi informasi dari himpunan mahasiswa teknologi informasi</h5>
