...
<head>
    ...
    <style>
        ...
        ul li:before {
            content: none;
            /* Ubah dari '•' menjadi none untuk menghilangkan bullet point */
        }
                    ...
                    <ul class="navbar-nav ms-auto">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="userDropdown">
                                <li><a class="dropdown-item" href="profile"><i class="fas fa-id-card me-2"></i>Profil
                                        Saya</a></li>
                                <li><a class="dropdown-item" href="settings"><i class="fas fa-cog me-2"></i>Pengaturan</a>
                                </li>
                                <li>
                    ...
                    <div class="card-body">
                        ...
                        @else
                            <div class="alert alert-info" role="alert">
                                Untuk menambahkan aspirasi, silakan <a href="{{ route('login') }}"
                                    class="alert-link">login</a> atau <a href="{{ route('register') }}"
                                    class="alert-link">daftar</a> terlebih dahulu.
                            </div>
                        @endauth

                        <!-- Daftar Aspirasi -->
                        <h4 class="mt-4 mb-3">Daftar Aspirasi</h4>
                                        ...
                                        <div class="card-body">
                                            <div class="d-flex justify-content-between align-items-center mb-2">
                                                <div class="small text-muted">
                                                    Anonim - {{ $aspirasi->created_at->format('d-m-Y H:i') }}
                                                </div>
                                                    ...
                                                    @if (Auth::id() === $aspirasi->user_id)
                                                        <form action="{{ route('aspirasi.destroy', $aspirasi) }}" method="POST">
                                                            ...
                                                            <button type="submit" class="btn btn-sm btn-danger"
                                                                onclick="return confirm('Apakah Anda yakin ingin menghapus aspirasi ini?')">Hapus</button>
                                                        </form>
                                                    @endif
                                                @endauth
                                            </div>
                                            <p class="card-text mb-0">{{ $aspirasi->komentar }}</p>
                                        </div>
                                    </div>
                                @endforeach
                            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-5">
                    ...
                    <p class="text-white text-decoration-none">Sistem Online Suara Aspirasi Mahasiswa Teknologi
                        Informasi</p>
                ...
                <div class="col-md-3">
                    ...
                    <ul class="list-unstyled">
                        <li><i class="fab fa-instagram me-2"></i><a
                                href="https://www.instagram.com/hmti.unimus?igsh=MWJpNno1cHh1NzQxZw=="
                                class="text-white text-decoration-none">@hmti.unimus</a></li>
                        <li><i class="fab fa-instagram me-2"></i><a
                                href="https://www.instagram.com/teukuzyn?igsh=MTUwOGUzY3R0ejBpMg=="
                                class="text-white text-decoration-none">@advokastrat.hmti</a></li>
                        <li><i class="fab fa-tiktok me-2"></i><a
                                href="https://www.tiktok.com/@hmti_unimus?_t=ZS-8wExdr4KAi1&_r=1"
                                class="text-white text-decoration-none">@hmti_unimus</a></li>
                    </ul>
                </div>
            </div>
